    ...
    return (
        <div className={style.bkImage}>
            <div className="text-center">
                <p className="text-[75px] text-white font-family: Roboto font-normal">{title}</p>
                <nav class="flex items-center justify-center" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        <li class="inline-flex items-center">
                            <Link href={homePageLink} class="inline-flex items-center text-sm font-medium text-white hover:text-[#99D31B] dark:text-gray-400 dark:hover:text-white">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link href={presentPageLink} className="font-family: Roboto text-[18px] ms-1 text-sm font-medium text-white hover:text-[#99D31B] md:ms-2 dark:text-gray-400 dark:hover:text-white">{presentPage}</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-white md:ms-2 dark:text-gray-400">{detailsPage}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
