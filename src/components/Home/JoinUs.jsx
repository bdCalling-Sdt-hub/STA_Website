      ...
      <div className="relative lg:p-[84px] p-4 mb-[84px] rounded-3xl -mt-6 bg-gradient-to-b from-[#1a1a19] to-[#323131]">
        ...
        <form action="https://formspree.io/f/xbjndjew" method="POST">
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <Input type="text" name="username" placeholder="Full Name" className={`${dm_sans.className} bg-[#333333] border-0 text-white placeholder:text-white`} />
            <Input type="email" name="email" placeholder="Email" className={`${dm_sans.className} bg-[#333333] border-0 text-white placeholder:text-white`} />
          </div>
          <Textarea
            name="message"
          ...
          <div className="text-center">
            <Button type="submit" className={`${dm_sans.className} bg-[#99D31B] mt-[60px] h-[60px] w-[185px] text-[18px] transition-all hover:bg-[#99D31B]`}>
              SEND MASSAGE
            </Button>
          </div>
        </form>
