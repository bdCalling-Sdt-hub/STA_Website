        ...
        <div className='container'>
            <section className="p-6 mt-[100px] dark:bg-gray-800 dark:text-gray-100">
                <div className="container p-4 mx-auto text-center">
                    ...
                    <p className={`${dm_sans.className} text-white text-[24px]`}>Our engineers apprehend your business requirements and help you choose the <br /><span>right technology for your solution.</span></p>
                </div>

                <div className='grid grid-flow-col'>
                    <div className='p-6 col-span-6'>
                        <p className={`${poppins.className} text-white text-[30px] mt-8`}>Mobile App Development</p>
                        <p className={`${poppins.className} text-white text-[24px] mt-8`}>Hybrid</p>
                        <hr />
                    ...
                    <div className='p-6 col-span-6'>
                        <p className={`${poppins.className} text-white text-[30px] mt-8`}>Web Development</p>
                        <p className={`${poppins.className} text-white text-[24px] mt-8`}>Frontend</p>
                        <hr />
